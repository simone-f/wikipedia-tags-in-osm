...
class Homepage(Helpers):
    def __init__(self, app, modeInfo):
        ...
        code += '\n      <ul>'
        code += '\n        <li><a href="http://josm.openstreetmap.de/wiki/Help/Plugin/Wikipedia" target="_blank">Plugin Wikipedia</a> per <a href="http://wiki.openstreetmap.org/wiki/IT:JOSM" target="_blank">JOSM</a>, facilita il tagging di articoli in una determinata zona o categoria.</li>'
        code += '\n        <li><a href="http://wiki.openstreetmap.org/wiki/JOSM/Plugins/RemoteControl/Add-tags" target="_blank">add-tags</a>, per cercare in OSM possibili oggetti corrispondenti agli articoli da taggare ed aggiungere facilmente i tag wikipedia.</li>'
        code += '\n      </ul>'
        code += '\n      </ul>'
